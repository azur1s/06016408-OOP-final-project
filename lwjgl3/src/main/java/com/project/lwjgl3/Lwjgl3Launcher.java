...
public class Lwjgl3Launcher {
    ...
    private static Lwjgl3ApplicationConfiguration getDefaultConfiguration() {
        ...
        configuration.setTitle("project");
        // Vsync limits the frames per second to what your hardware can display, and
        // helps eliminate
        // screen tearing. This setting doesn't always work on Linux, so the line after
        // is a safeguard.
        ...
        // drivers, Macs
        // with Apple Silicon that have to emulate compatibility with OpenGL anyway, and
        // more.
        // This uses the dependency `com.badlogicgames.gdx:gdx-lwjgl3-angle` to
        // function.
        // You would need to add this line to lwjgl3/build.gradle , below the dependency
        // on `gdx-backend-lwjgl3`:
        // implementation "com.badlogicgames.gdx:gdx-lwjgl3-angle:$gdxVersion"
        // You can choose to add the following line and the mentioned dependency if you
        // want; they
